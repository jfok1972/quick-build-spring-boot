...
public class Module {
	...
	@SystemLogs("获取系统模块数据")
	@RequestMapping(value = "/getmoduleinfo.do")
	
	public FModule getModuleInfo(String moduleid, String moduleName) {
		return service.getModuleInfo(moduleName == null ? moduleid : moduleName);
	}
	 ...
	 * @return
	 */
	@RequestMapping("/addtocompanymodule.do")
	...
	@RequestMapping("/getgridscheme.do")
	...
	@RequestMapping("/getformscheme.do")
	...
	@RequestMapping("/getsortscheme.do")
	...
	@RequestMapping("/getfilterscheme.do")
	...
	@RequestMapping(value = "/getmodulegridsinfo.do")
	 ...
	 * 根据模块名称，取得所有的字段
	 */
	@RequestMapping("/getModuleFields.do")
	 ...
	 * @return
	 */
	@RequestMapping("/getModuleHierarchyTree.do")
