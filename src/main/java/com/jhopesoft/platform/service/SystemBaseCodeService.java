...
public class SystemBaseCodeService {
	...
	public List<Map<String, Object>> getViewList(String viewname, String ids, String idfield, String textfield,
			String orderbyfield) {
		String id = CommonUtils.isEmpty(idfield) ? Constants.ID : idfield;
		String text = CommonUtils.isEmpty(textfield) ? Constants.TEXT : textfield;
	...
	public Map<String, String> getColumnMapping(String viewname) {
		...
		for (int i = 0; i < list.size(); i++) {
			...
			map.put(((String) r.get(Constants.ID)).trim(), (String) r.get(Constants.TEXT));
		}
		return map;
	}
