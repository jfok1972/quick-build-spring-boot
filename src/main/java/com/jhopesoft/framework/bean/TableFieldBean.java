...
public class TableFieldBean implements Serializable {
  ...
  public void setDbfieldtype(String dbfieldtype) {
    ...
    public String toString() {
      return "TableFieldBean [comments=" + comments + ", dataprecision=" + dataprecision + ", datascale=" + datascale
          + ", dbfieldtype=" + dbfieldtype + ", fieldlen=" + fieldlen + ", fieldname=" + fieldname + ", fieldrelation="
          + fieldrelation + ", fieldtitle=" + fieldtitle + ", fieldtype=" + fieldtype + ", isrequired=" + isrequired
          + ", joincolumnname=" + joincolumnname + ", jointable=" + jointable + ", multiple=" + multiple + "]";
    }
